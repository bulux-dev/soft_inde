var numeroALetrasMoneda = (function () {
  ...
  function Billones(num) {
    ...
    let strBillones = Seccion(num, divisor, 'UN BILLON', 'BILLONES');
    if (parseInt(resto) == 0) {
      strBillones = Seccion(num, divisor, 'UN BILLON DE', 'BILLONES DE');
    }
  ...
  return function NumeroALetras(num, currency = null) {
    ...
    if (data.enteros == 1)
      return Billones(data.enteros) + ' ' + data.letrasMonedaSingular + ' ' + data.letrasCentavos;
    else
